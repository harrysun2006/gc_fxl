package fxl.xls
{
  ...
  {
    public static const T_GLOBALS:uint = 0x05;
    public static const T_VBMODULE:uint = 0x06;
    public static const T_SHEET:uint = 0x10;
    public static const T_CHART:uint = 0x20;
    public static const T_MACROSHEET:uint = 0x40;
    public static const T_WORKSPACE:uint = 0x100;
    ...
    public function Worksheet(book:Workbook)
    {
      _book = book;
      _formats = new Array();
      _xformats = new Array();
     ...
     *
     */
    public function cell(row:uint, col:uint):Cell
    {
      // Create a cell if one doesn't exist yet
      return (row < _values.length && col < _values[row].length) ? _values[row][col] : null;
    /*
    ...
    public function get xformats():Array
    {
      return _xformats;
    }
    public function set xformats(value:Array):void
    {
      _xformats = value;
    }
    ...
    public function get dateMode():uint
    {
      return _dateMode;
    }
    ...
    public function get book():Workbook
    {
      return _book;
    }
